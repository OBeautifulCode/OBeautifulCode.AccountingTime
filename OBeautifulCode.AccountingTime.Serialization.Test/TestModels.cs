    ...
    public static class TestModels
    {
        public static ReportingPeriodModelWrapper GetDummyReportingPeriodModelWrapper()
        {
            var result = new ReportingPeriodModelWrapper
            {
                ...
                CalendarUnitOfTime = AccountingTimeDummyFactory.GetDummyCalendarReportingPeriod(),
                CalendarDay = AccountingTimeDummyFactory.GetDummyCalendarDayReportingPeriod(),
                CalendarMonth = AccountingTimeDummyFactory.GetDummyCalendarMonthReportingPeriod(),
                CalendarQuarter = AccountingTimeDummyFactory.GetDummyCalendarQuarterReportingPeriod(),
                CalendarUnbounded = AccountingTimeDummyFactory.GetDummyCalendarUnboundedReportingPeriod(),
                CalendarYear = AccountingTimeDummyFactory.GetDummyCalendarYearReportingPeriod(),
                FiscalUnitOfTime = AccountingTimeDummyFactory.GetDummyFiscalReportingPeriod(),
                FiscalMonth = AccountingTimeDummyFactory.GetDummyFiscalMonthReportingPeriod(),
                FiscalQuarter = AccountingTimeDummyFactory.GetDummyFiscalQuarterReportingPeriod(),
                FiscalUnbounded = AccountingTimeDummyFactory.GetDummyFiscalUnboundedReportingPeriod(),
                FiscalYear = AccountingTimeDummyFactory.GetDummyFiscalYearReportingPeriod(),
                GenericUnitOfTime = AccountingTimeDummyFactory.GetDummyGenericReportingPeriod(),
                GenericMonth = AccountingTimeDummyFactory.GetDummyGenericMonthReportingPeriod(),
                GenericQuarter = AccountingTimeDummyFactory.GetDummyGenericQuarterReportingPeriod(),
                GenericUnbounded = AccountingTimeDummyFactory.GetDummyGenericUnboundedReportingPeriod(),
                GenericYear = AccountingTimeDummyFactory.GetDummyGenericYearReportingPeriod(),
            };
