...
namespace OBeautifulCode.AccountingTime
{
    ...
    public class GenericMonth : GenericUnitOfTime, IHaveAMonth, IEquatable<GenericMonth>, IComparable<GenericMonth>, IComparable
    {
        ...
        public GenericMonth(int year, MonthNumber monthNumber)
        {
            ...
            // if ((month < 1) || (month > 4))
            // {
            //     throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "GenericMonth must be between 1 and 4 (inclusive).  MonthNumber provided was: {0}", month));
            // }
        ...
        public static bool operator <(GenericMonth left, GenericMonth right) => left.CompareTo(right) < 0;
        ...
        public override string ToString()
        {
            ...
            return $"{(int)this.MonthNumber:D2}{monthNumberSuffix} of {this.Year}";
        }
    }
}
