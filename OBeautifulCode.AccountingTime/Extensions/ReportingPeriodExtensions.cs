...
namespace OBeautifulCode.AccountingTime
{
    ...
    public static class ReportingPeriodExtensions
    {
        ...
        /// <summary>
        /// Converts a <see cref="IReportingPeriod{GenericUnitOfTime}"/> to a specified kind of reporting period.
        /// </summary>
        /// <param name="reportingPeriod">The generic reporting period to convert.</param>
        /// <param name="unitOfTimeKind">The kind of unit-of-time to convert to.</param>
        /// <returns>
        /// The specified reporting period converted to the specified kind of unit-of-time.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="reportingPeriod"/> is null.</exception>
        /// <exception cref="ArgumentException"><paramref name="unitOfTimeKind"/> is <see cref="UnitOfTimeKind.Invalid"/>.</exception>
        public static IReportingPeriod<UnitOfTime> ToKind(this IReportingPeriod<GenericUnitOfTime> reportingPeriod, UnitOfTimeKind unitOfTimeKind)
        {
            if (reportingPeriod == null)
            {
                throw new ArgumentNullException(nameof(reportingPeriod));
            ...
            {
                result = reportingPeriod.ToGeneric();
            }
            else if (unitOfTimeKind == UnitOfTimeKind.Calendar)
            {
                result = reportingPeriod.ToCalendar();
            }
            else if (unitOfTimeKind == UnitOfTimeKind.Fiscal)
            {
                result = reportingPeriod.ToFiscal();
            }
            else
            {
        ...
        /// <summary>
        /// Converts a <see cref="IReportingPeriod{GenericUnitOfTime}"/> to a <see cref="IReportingPeriod{CalendarUnitOfTime}"/>.
        /// </summary>
        /// <param name="reportingPeriod">The reporting period to convert.</param>
        /// <returns>
        /// The specified generic reporting period converted to a calendar reporting period.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="reportingPeriod"/> is null.</exception>
        public static IReportingPeriod<CalendarUnitOfTime> ToCalendar(this IReportingPeriod<GenericUnitOfTime> reportingPeriod)
        {
            if (reportingPeriod == null)
            {
                throw new ArgumentNullException(nameof(reportingPeriod));
            ...
            var start = reportingPeriod.Start.ToCalendar();
            var end = reportingPeriod.End.ToCalendar();
            var result = new ReportingPeriod<CalendarUnitOfTime>(start, end);
            return result;
        }

        /// <summary>
        /// Converts a <see cref="IReportingPeriod{GenericUnitOfTime}"/> to a <see cref="IReportingPeriod{FiscalUnitOfTime}"/>.
        /// </summary>
        /// <param name="reportingPeriod">The reporting period to convert.</param>
        /// <returns>
        /// The specified generic reporting period converted to a fiscal reporting period.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="reportingPeriod"/> is null.</exception>
        public static IReportingPeriod<FiscalUnitOfTime> ToFiscal(this IReportingPeriod<GenericUnitOfTime> reportingPeriod)
        {
            if (reportingPeriod == null)
            {
                throw new ArgumentNullException(nameof(reportingPeriod));
            ...
            var start = reportingPeriod.Start.ToFiscal();
            var end = reportingPeriod.End.ToFiscal();
            var result = new ReportingPeriod<FiscalUnitOfTime>(start, end);
            return result;
        }

        /// <summary>
        /// Converts a <see cref="IReportingPeriod{GenericUnitOfTime}"/> to a <see cref="IReportingPeriod{GenericUnitOfTime}"/>.
        /// </summary>
        /// <param name="reportingPeriod">The reporting period to convert.</param>
        /// <returns>
        /// The specified generic reporting period converted to a generic reporting period.
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="reportingPeriod"/> is null.</exception>
        public static IReportingPeriod<GenericUnitOfTime> ToGeneric(this IReportingPeriod<GenericUnitOfTime> reportingPeriod)
        {
            if (reportingPeriod == null)
            {
                throw new ArgumentNullException(nameof(reportingPeriod));
            ...
            var start = reportingPeriod.Start.ToGeneric();
            var end = reportingPeriod.End.ToGeneric();
            var result = new ReportingPeriod<GenericUnitOfTime>(start, end);
            return result;
        }
