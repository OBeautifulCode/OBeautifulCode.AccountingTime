...
namespace OBeautifulCode.AccountingTime
{
    ...
    [Serializable]
    public partial class GenericMonth : IModel<GenericMonth>, IComparableForRelativeSortOrder<GenericMonth>
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public bool Equals(GenericMonth other)
        {
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="GenericMonth"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="GenericMonth"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="GenericMonth"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="GenericMonth"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (!(obj is GenericMonth other))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'GenericMonth' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(UnitOfTime other)
        {
            ...
            if (!(other is GenericMonth otherAsGenericMonth))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'GenericMonth' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsGenericMonth);
        ...
        /// <inheritdoc />
        public new GenericMonth DeepClone() => (GenericMonth)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="GenericMonth" /> using the specified <paramref name="year" /> for <see cref="Year" /> and a deep clone of every other property.</returns>
        ...
        public GenericMonth DeepCloneWithYear(int year)
        {
        ...
        /// <returns>New <see cref="GenericMonth" /> using the specified <paramref name="monthNumber" /> for <see cref="MonthNumber" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
