...
namespace OBeautifulCode.AccountingTime
{
    ...
    [Serializable]
    public partial class FiscalMonth : IModel<FiscalMonth>, IComparableForRelativeSortOrder<FiscalMonth>
    {
        /// <summary>
        ...
        public bool Equals(FiscalMonth other)
        {
            ...
            var result = this.Year.IsEqualTo(other.Year)
                      && this.MonthNumber.IsEqualTo(other.MonthNumber);
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalMonth"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalMonth"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalMonth"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalMonth"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        public override int CompareTo(object obj)
        {
            ...
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'FiscalMonth' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(UnitOfTime other)
        {
            ...
            if (!(other is FiscalMonth otherAsFiscalMonth))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'FiscalMonth' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsFiscalMonth);
        ...
        /// <inheritdoc />
        public new FiscalMonth DeepClone() => (FiscalMonth)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="FiscalMonth" /> using the specified <paramref name="year" /> for <see cref="Year" /> and a deep clone of every other property.</returns>
        ...
        public FiscalMonth DeepCloneWithYear(int year)
        {
            var result = new FiscalMonth(
                                 year,
                                 this.MonthNumber.DeepClone());

            return result;
        }

        /// <summary>
        /// Deep clones this object with a new <see cref="MonthNumber" />.
        /// </summary>
        /// <param name="monthNumber">The new <see cref="MonthNumber" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="FiscalMonth" /> using the specified <paramref name="monthNumber" /> for <see cref="MonthNumber" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MonthNumber, options, propertyPathTracker, nameof(this.MonthNumber));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
