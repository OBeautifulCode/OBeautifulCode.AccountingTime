...
namespace OBeautifulCode.AccountingTime
{
    ...
    [Serializable]
    public partial class FiscalQuarter : IModel<FiscalQuarter>, IComparableForRelativeSortOrder<FiscalQuarter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalQuarter"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalQuarter"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalQuarter"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="FiscalQuarter"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (!(obj is FiscalQuarter other))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'FiscalQuarter' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(UnitOfTime other)
        {
            ...
            if (!(other is FiscalQuarter otherAsFiscalQuarter))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'FiscalQuarter' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsFiscalQuarter);
        ...
        /// <inheritdoc />
        public new FiscalQuarter DeepClone() => (FiscalQuarter)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="FiscalQuarter" /> using the specified <paramref name="quarterNumber" /> for <see cref="QuarterNumber" /> and a deep clone of every other property.</returns>
        ...
        /// <returns>New <see cref="FiscalQuarter" /> using the specified <paramref name="year" /> for <see cref="Year" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public FiscalQuarter DeepCloneWithYear(int year)
        {
            var result = new FiscalQuarter(
                                 year,
                                 this.QuarterNumber.DeepClone());
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.QuarterNumber, options, propertyPathTracker, nameof(this.QuarterNumber));
