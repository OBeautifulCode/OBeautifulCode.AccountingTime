...
namespace OBeautifulCode.AccountingTime
{
    ...
    [Serializable]
    public partial class CalendarDay : IModel<CalendarDay>, IComparableForRelativeSortOrder<CalendarDay>
    {
        /// <summary>
        ...
        public bool Equals(CalendarDay other)
        {
            ...
            var result = this.Year.IsEqualTo(other.Year)
                      && this.MonthOfYear.IsEqualTo(other.MonthOfYear)
                      && this.DayOfMonth.IsEqualTo(other.DayOfMonth);
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="CalendarDay"/> is less than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="CalendarDay"/> is greater than another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="CalendarDay"/> is less than or equal to another object of that type.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether an object of type <see cref="CalendarDay"/> is greater than or equal to another object of that type.
        /// </summary>
        ...
        public override int CompareTo(object obj)
        {
            ...
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'CalendarDay' whereas the other object is of type '{obj.GetType().ToStringReadable()}'."));
            }
        ...
        public override RelativeSortOrder CompareToForRelativeSortOrder(UnitOfTime other)
        {
            ...
            if (!(other is CalendarDay otherAsCalendarDay))
            {
                throw new ArgumentException(Invariant($"Attempting to compare objects of different types.  This object is of type 'CalendarDay' whereas the other object is of type '{other.GetType().ToStringReadable()}'."));
            }

            var result = this.CompareToForRelativeSortOrder(otherAsCalendarDay);
        ...
        /// <inheritdoc />
        public new CalendarDay DeepClone() => (CalendarDay)this.DeepCloneInternal();
        ...
        /// <returns>New <see cref="CalendarDay" /> using the specified <paramref name="year" /> for <see cref="Year" /> and a deep clone of every other property.</returns>
        ...
        public CalendarDay DeepCloneWithYear(int year)
        {
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="MonthOfYear" />.
        /// </summary>
        /// <param name="monthOfYear">The new <see cref="MonthOfYear" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="CalendarDay" /> using the specified <paramref name="monthOfYear" /> for <see cref="MonthOfYear" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="DayOfMonth" />.
        /// </summary>
        /// <param name="dayOfMonth">The new <see cref="DayOfMonth" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="CalendarDay" /> using the specified <paramref name="dayOfMonth" /> for <see cref="DayOfMonth" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Year, options, propertyPathTracker, nameof(this.Year));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MonthOfYear, options, propertyPathTracker, nameof(this.MonthOfYear));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DayOfMonth, options, propertyPathTracker, nameof(this.DayOfMonth));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
