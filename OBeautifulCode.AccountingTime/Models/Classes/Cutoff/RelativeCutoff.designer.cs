    ...
    public partial class RelativeCutoff : IModel<RelativeCutoff>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.Duration, options, propertyPathTracker, nameof(this.Duration));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StartOrEnd, options, propertyPathTracker, nameof(this.StartOrEnd));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
