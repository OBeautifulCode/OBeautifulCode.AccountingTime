    ...
    public partial class UnitKindAssociation : IModel<UnitKindAssociation>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ReportingPeriod1, options, propertyPathTracker, nameof(this.ReportingPeriod1));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ReportingPeriod2, options, propertyPathTracker, nameof(this.ReportingPeriod2));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
