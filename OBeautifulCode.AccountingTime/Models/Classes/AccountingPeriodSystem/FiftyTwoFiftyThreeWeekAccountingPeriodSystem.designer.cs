    ...
    public partial class FiftyTwoFiftyThreeWeekAccountingPeriodSystem : IModel<FiftyTwoFiftyThreeWeekAccountingPeriodSystem>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.LastDayOfWeekInAccountingYear, options, propertyPathTracker, nameof(this.LastDayOfWeekInAccountingYear));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.AnchorMonth, options, propertyPathTracker, nameof(this.AnchorMonth));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.FiftyTwoFiftyThreeWeekMethodology, options, propertyPathTracker, nameof(this.FiftyTwoFiftyThreeWeekMethodology));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
