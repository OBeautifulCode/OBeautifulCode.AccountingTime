...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly FiscalUnitOfTime ReferenceObjectForEquatableTestScenarios = A.Dummy<FiscalUnitOfTime>();

        private static readonly EquatableTestScenarios<FiscalUnitOfTime> EquatableTestScenarios = new EquatableTestScenarios<FiscalUnitOfTime>()
            .AddScenario(() =>
                new EquatableTestScenario<FiscalUnitOfTime>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new FiscalUnitOfTime[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new FiscalUnitOfTime[]
                    {
                    ...
                    {
                        A.Dummy<FiscalUnitOfTime>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        private static readonly ComparableTestScenarios<FiscalUnitOfTime> ComparableTestScenarios = new ComparableTestScenarios<FiscalUnitOfTime>();
        ...
        public static class Structural
        {
            ...
            public static void FiscalUnitOfTime___Should_implement_IModel_of_FiscalUnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(FiscalUnitOfTime);

                var expectedModelMethods = typeof(IModel<FiscalUnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<FiscalUnitOfTime>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FiscalUnitOfTime___Should_implement_IComparableForRelativeSortOrder_of_FiscalUnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(FiscalUnitOfTime);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<FiscalUnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IComparableForRelativeSortOrder<FiscalUnitOfTime>));
                expectedModelMethodHashes.Except(actualModelMethodHashes).AsTest().Must().BeEmptyEnumerable();
            }
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FiscalUnitOfTime___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(FiscalUnitOfTime);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<FiscalUnitOfTime>();

                // Act
                var actual = (FiscalUnitOfTime)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<FiscalUnitOfTime>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                FiscalUnitOfTime systemUnderTest1 = null;
                FiscalUnitOfTime systemUnderTest2 = null;
