...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly GenericUnitOfTime ReferenceObjectForEquatableTestScenarios = A.Dummy<GenericUnitOfTime>();

        private static readonly EquatableTestScenarios<GenericUnitOfTime> EquatableTestScenarios = new EquatableTestScenarios<GenericUnitOfTime>()
            .AddScenario(() =>
                new EquatableTestScenario<GenericUnitOfTime>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GenericUnitOfTime[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GenericUnitOfTime[]
                    {
                    ...
                    {
                        A.Dummy<GenericUnitOfTime>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        private static readonly ComparableTestScenarios<GenericUnitOfTime> ComparableTestScenarios = new ComparableTestScenarios<GenericUnitOfTime>();
        ...
        public static class Structural
        {
            ...
            public static void GenericUnitOfTime___Should_implement_IModel_of_GenericUnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(GenericUnitOfTime);

                var expectedModelMethods = typeof(IModel<GenericUnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GenericUnitOfTime>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GenericUnitOfTime___Should_implement_IComparableForRelativeSortOrder_of_GenericUnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(GenericUnitOfTime);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<GenericUnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IComparableForRelativeSortOrder<GenericUnitOfTime>));
                expectedModelMethodHashes.Except(actualModelMethodHashes).AsTest().Must().BeEmptyEnumerable();
            }
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GenericUnitOfTime___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GenericUnitOfTime);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<GenericUnitOfTime>();

                // Act
                var actual = (GenericUnitOfTime)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GenericUnitOfTime>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GenericUnitOfTime systemUnderTest1 = null;
                GenericUnitOfTime systemUnderTest2 = null;
