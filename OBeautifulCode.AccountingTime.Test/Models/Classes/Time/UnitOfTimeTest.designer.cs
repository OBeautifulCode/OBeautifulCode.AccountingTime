...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly UnitOfTime ReferenceObjectForEquatableTestScenarios = A.Dummy<UnitOfTime>();

        private static readonly EquatableTestScenarios<UnitOfTime> EquatableTestScenarios = new EquatableTestScenarios<UnitOfTime>()
            .AddScenario(() =>
                new EquatableTestScenario<UnitOfTime>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new UnitOfTime[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new UnitOfTime[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new UnitOfTime[]
                    {
                        A.Dummy<UnitOfTime>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        private static readonly ComparableTestScenarios<UnitOfTime> ComparableTestScenarios = new ComparableTestScenarios<UnitOfTime>();
        ...
        public static class Structural
        {
            ...
            public static void UnitOfTime___Should_implement_IModel_of_UnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(UnitOfTime);

                var expectedModelMethods = typeof(IModel<UnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<UnitOfTime>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UnitOfTime___Should_implement_IComparableForRelativeSortOrder_of_UnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(UnitOfTime);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<UnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IComparableForRelativeSortOrder<UnitOfTime>));
                expectedModelMethodHashes.Except(actualModelMethodHashes).AsTest().Must().BeEmptyEnumerable();
            }
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UnitOfTime___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(UnitOfTime);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (UnitOfTime)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<UnitOfTime>();
