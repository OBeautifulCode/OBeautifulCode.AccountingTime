...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly CalendarUnitOfTime ReferenceObjectForEquatableTestScenarios = A.Dummy<CalendarUnitOfTime>();

        private static readonly EquatableTestScenarios<CalendarUnitOfTime> EquatableTestScenarios = new EquatableTestScenarios<CalendarUnitOfTime>()
            .AddScenario(() =>
                new EquatableTestScenario<CalendarUnitOfTime>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CalendarUnitOfTime[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CalendarUnitOfTime[]
                    {
                    ...
                    {
                        A.Dummy<CalendarUnitOfTime>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        private static readonly ComparableTestScenarios<CalendarUnitOfTime> ComparableTestScenarios = new ComparableTestScenarios<CalendarUnitOfTime>();
        ...
        public static class Structural
        {
            ...
            public static void CalendarUnitOfTime___Should_implement_IModel_of_CalendarUnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(CalendarUnitOfTime);

                var expectedModelMethods = typeof(IModel<CalendarUnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CalendarUnitOfTime>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CalendarUnitOfTime___Should_implement_IComparableForRelativeSortOrder_of_CalendarUnitOfTime___When_reflecting()
            {
                // Arrange
                var type = typeof(CalendarUnitOfTime);

                var expectedModelMethods = typeof(IComparableForRelativeSortOrder<CalendarUnitOfTime>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IComparableForRelativeSortOrder<CalendarUnitOfTime>));
                expectedModelMethodHashes.Except(actualModelMethodHashes).AsTest().Must().BeEmptyEnumerable();
            }
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CalendarUnitOfTime___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CalendarUnitOfTime);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<CalendarUnitOfTime>();

                // Act
                var actual = (CalendarUnitOfTime)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CalendarUnitOfTime>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CalendarUnitOfTime systemUnderTest1 = null;
                CalendarUnitOfTime systemUnderTest2 = null;
