...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    public static partial class FixedCutoffTest
    {
        ...
        private static readonly ValidModelTestScenarios<FixedCutoff> ValidModelTestScenarios = new ValidModelTestScenarios<FixedCutoff>()
            .AddScenario(() =>
                new ValidModelTestScenario<FixedCutoff>
                {
                    Name = "a dummy FixedCutoff should be valid",
                    SystemUnderTest = A.Dummy<FixedCutoff>(),
                });
