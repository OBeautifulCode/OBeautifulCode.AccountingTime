...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ReportingPeriod> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ReportingPeriod>();

        private static readonly ConstructorArgumentValidationTestScenarios<ReportingPeriod> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ReportingPeriod>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ReportingPeriod>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'start' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ReportingPeriod>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ReportingPeriod> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ReportingPeriod>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ReportingPeriod>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ReportingPeriod>
                        {
        ...
        private static readonly DeepCloneWithTestScenarios<ReportingPeriod> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ReportingPeriod>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReportingPeriod>
                {
                    ...
                    {
                        var systemUnderTest = A.Dummy<ReportingPeriod>();

                        var referenceObject = A.Dummy<ReportingPeriod>().ThatIs(_ => !systemUnderTest.Start.IsEqualTo(_.Start));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ReportingPeriod>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ReportingPeriod>().ThatIs(_ => !systemUnderTest.End.IsEqualTo(_.End));
        ...
        private static readonly ReportingPeriod ReferenceObjectForEquatableTestScenarios = A.Dummy<ReportingPeriod>();

        private static readonly EquatableTestScenarios<ReportingPeriod> EquatableTestScenarios = new EquatableTestScenarios<ReportingPeriod>()
            .AddScenario(() =>
                new EquatableTestScenario<ReportingPeriod>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ReportingPeriod[]
                    {
                        new ReportingPeriod(
                                ReferenceObjectForEquatableTestScenarios.Start,
                                ReferenceObjectForEquatableTestScenarios.End),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ReportingPeriod[]
                    {
                        new ReportingPeriod(
                                A.Dummy<ReportingPeriod>().Whose(_ => !_.Start.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Start)).Start,
                                ReferenceObjectForEquatableTestScenarios.End),
                        new ReportingPeriod(
                                ReferenceObjectForEquatableTestScenarios.Start,
                                A.Dummy<ReportingPeriod>().Whose(_ => !_.End.IsEqualTo(ReferenceObjectForEquatableTestScenarios.End)).End),
                    },
        ...
        private static readonly ValidModelTestScenarios<ReportingPeriod> ValidModelTestScenarios = new ValidModelTestScenarios<ReportingPeriod>()
            .AddScenario(() =>
                new ValidModelTestScenario<ReportingPeriod>
                {
                    Name = "a dummy ReportingPeriod should be valid",
                    SystemUnderTest = A.Dummy<ReportingPeriod>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void ReportingPeriod___Should_implement_IModel_of_ReportingPeriod___When_reflecting()
            {
                // Arrange
                var type = typeof(ReportingPeriod);

                var expectedModelMethods = typeof(IModel<ReportingPeriod>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ReportingPeriod>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ReportingPeriod___Should_declare_ToString_method___When_reflecting()
            {
                // Arrange
                var expected = typeof(ReportingPeriod);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ReportingPeriod___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ReportingPeriod);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ReportingPeriod)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ReportingPeriod)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ReportingPeriod).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ReportingPeriod>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ReportingPeriod systemUnderTest1 = null;
                ReportingPeriod systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ReportingPeriod systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReportingPeriod___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
