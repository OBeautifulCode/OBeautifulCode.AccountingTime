...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    public static partial class UnitTest
    {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Unit> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Unit>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Unit>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Unit>
                        {
                            SystemUnderTest = new Unit(
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Unit>
                {
                    Name = "Granularity should return same 'granularity' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Unit>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<Unit>
                        {
                            SystemUnderTest = new Unit(
                                                      referenceObject.Kind,
                                                      referenceObject.Granularity),
                            ExpectedPropertyValue = referenceObject.Granularity,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<Unit> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Unit>()
            .AddScenario(() =>
        ...
        private static readonly Unit ReferenceObjectForEquatableTestScenarios = A.Dummy<Unit>();

        private static readonly EquatableTestScenarios<Unit> EquatableTestScenarios = new EquatableTestScenarios<Unit>()
            .AddScenario(() =>
                new EquatableTestScenario<Unit>
                {
                    ...
                    {
                        new Unit(
                                A.Dummy<Unit>().Whose(_ => !_.Kind.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Kind)).Kind,
                                ReferenceObjectForEquatableTestScenarios.Granularity),
                        new Unit(
                                ReferenceObjectForEquatableTestScenarios.Kind,
                                A.Dummy<Unit>().Whose(_ => !_.Granularity.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Granularity)).Granularity),
                    },
        ...
        private static readonly ValidModelTestScenarios<Unit> ValidModelTestScenarios = new ValidModelTestScenarios<Unit>()
            .AddScenario(() =>
                new ValidModelTestScenario<Unit>
                {
                    Name = "a dummy Unit should be valid",
                    SystemUnderTest = A.Dummy<Unit>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void Unit___Should_implement_IModel_of_Unit___When_reflecting()
            {
                // Arrange
                var type = typeof(Unit);

                var expectedModelMethods = typeof(IModel<Unit>).GetInterfaceDeclaredAndImplementedMethods();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Unit___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Unit);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Unit)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Kind", "Granularity" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Unit)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Unit).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Unit systemUnderTest1 = null;
                Unit systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Unit___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Unit___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Unit___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Unit___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Unit___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
