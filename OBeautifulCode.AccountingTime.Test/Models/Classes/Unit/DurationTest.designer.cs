...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Duration> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Duration>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Duration>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Duration>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Duration>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.AccountingTime.Duration: Quantity = {systemUnderTest.Quantity.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Unit = {systemUnderTest.Unit?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Duration> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Duration>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Duration> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Duration>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Duration>
                {
                    Name = "Quantity should return same 'quantity' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Duration>();

                        var result = new SystemUnderTestExpectedPropertyValue<Duration>
                        {
                            SystemUnderTest = new Duration(
                                                      referenceObject.Quantity,
                                                      referenceObject.Unit),
                            ExpectedPropertyValue = referenceObject.Quantity,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<Duration> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Duration>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Duration>
                {
                    Name = "DeepCloneWithQuantity should deep clone object and replace Quantity with the provided quantity",
                    WithPropertyName = "Quantity",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Duration>();

                        var referenceObject = A.Dummy<Duration>().ThatIs(_ => !systemUnderTest.Quantity.IsEqualTo(_.Quantity));

                        var result = new SystemUnderTestDeepCloneWithValue<Duration>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Quantity,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Duration>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Duration>().ThatIs(_ => !systemUnderTest.Unit.IsEqualTo(_.Unit));
        ...
        private static readonly Duration ReferenceObjectForEquatableTestScenarios = A.Dummy<Duration>();

        private static readonly EquatableTestScenarios<Duration> EquatableTestScenarios = new EquatableTestScenarios<Duration>()
            .AddScenario(() =>
                new EquatableTestScenario<Duration>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Duration[]
                    {
                        new Duration(
                                ReferenceObjectForEquatableTestScenarios.Quantity,
                                ReferenceObjectForEquatableTestScenarios.Unit),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Duration[]
                    {
                        new Duration(
                                A.Dummy<Duration>().Whose(_ => !_.Quantity.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Quantity)).Quantity,
                                ReferenceObjectForEquatableTestScenarios.Unit),
                        new Duration(
                                ReferenceObjectForEquatableTestScenarios.Quantity,
                                A.Dummy<Duration>().Whose(_ => !_.Unit.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Unit)).Unit),
                    },
        ...
        private static readonly ValidModelTestScenarios<Duration> ValidModelTestScenarios = new ValidModelTestScenarios<Duration>()
            .AddScenario(() =>
                new ValidModelTestScenario<Duration>
                {
                    Name = "a dummy Duration should be valid",
                    SystemUnderTest = A.Dummy<Duration>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void Duration___Should_implement_IModel_of_Duration___When_reflecting()
            {
                // Arrange
                var type = typeof(Duration);

                var expectedModelMethods = typeof(IModel<Duration>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Duration>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Duration___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Duration);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Duration)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Quantity", "Unit" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Duration)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Duration).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Duration systemUnderTest1 = null;
                Duration systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Duration___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Duration___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Duration___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Duration___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Duration___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
