...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Timeseries<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Timeseries<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Timeseries<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Timeseries<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Timeseries<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.AccountingTime.Timeseries<Version>: Datapoints = {systemUnderTest.Datapoints?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Timeseries<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Timeseries<Version>>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Timeseries<Version>>
                {
                    Name = "constructor should throw ArgumentException when parameter 'datapoints' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new Timeseries<Version>(
                                             new List<Datapoint<Version>>());

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "datapoints", "is an empty enumerable", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Timeseries<Version>>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Timeseries<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Timeseries<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Timeseries<Version>>
                {
                    Name = "Datapoints should return same 'datapoints' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Timeseries<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Timeseries<Version>>
                        {
                            SystemUnderTest = new Timeseries<Version>(
                                                      referenceObject.Datapoints),
                            ExpectedPropertyValue = referenceObject.Datapoints,
                        };

                        return result;
                    },
                    PropertyName = "Datapoints",
                });

        private static readonly DeepCloneWithTestScenarios<Timeseries<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Timeseries<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Timeseries<Version>>
                {
                    Name = "DeepCloneWithDatapoints should deep clone object and replace Datapoints with the provided datapoints",
                    WithPropertyName = "Datapoints",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Timeseries<Version>>();

                        var referenceObject = A.Dummy<Timeseries<Version>>().ThatIs(_ => !systemUnderTest.Datapoints.IsEqualTo(_.Datapoints));

                        var result = new SystemUnderTestDeepCloneWithValue<Timeseries<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Datapoints,
                        };
        ...
        private static readonly Timeseries<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<Timeseries<Version>>();

        private static readonly EquatableTestScenarios<Timeseries<Version>> EquatableTestScenarios = new EquatableTestScenarios<Timeseries<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<Timeseries<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Timeseries<Version>[]
                    {
                        new Timeseries<Version>(
                                ReferenceObjectForEquatableTestScenarios.Datapoints),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Timeseries<Version>[]
                    {
                        new Timeseries<Version>(
                                A.Dummy<Timeseries<Version>>().Whose(_ => !_.Datapoints.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Datapoints)).Datapoints),
                    },
        ...
        private static readonly ValidModelTestScenarios<Timeseries<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<Timeseries<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<Timeseries<Version>>
                {
                    Name = "a dummy Timeseries<Version> should be valid",
                    SystemUnderTest = A.Dummy<Timeseries<Version>>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void Timeseries_of_Version___Should_implement_IModel_of_Timeseries_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(Timeseries<Version>);

                var expectedModelMethods = typeof(IModel<Timeseries<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Timeseries<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Timeseries_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Timeseries<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Timeseries<Version>)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Datapoints == null)
                {
                    actual.Datapoints.AsTest().Must().BeNull();
                }
                else if (!actual.Datapoints.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Datapoints.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Datapoints);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Datapoints" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Timeseries<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Timeseries<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Timeseries<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Timeseries<Version> systemUnderTest1 = null;
                Timeseries<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Timeseries<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Timeseries_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Timeseries_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Timeseries_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Timeseries_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Timeseries_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
