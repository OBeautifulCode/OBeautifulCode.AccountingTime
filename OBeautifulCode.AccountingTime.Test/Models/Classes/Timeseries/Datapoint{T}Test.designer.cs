...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<Datapoint<Version>> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Datapoint<Version>>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Datapoint<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Datapoint<Version>>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Datapoint<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.AccountingTime.Datapoint<Version>: ReportingPeriod = {systemUnderTest.ReportingPeriod?.ToString() ?? "<null>"}, Value = {systemUnderTest.Value?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Datapoint<Version>> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Datapoint<Version>>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Datapoint<Version>>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        ...
                        var result = new Datapoint<Version>(
                                             referenceObject.ReportingPeriod,
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Datapoint<Version>> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Datapoint<Version>>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Datapoint<Version>>
                {
                    Name = "ReportingPeriod should return same 'reportingPeriod' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<Datapoint<Version>>();

                        var result = new SystemUnderTestExpectedPropertyValue<Datapoint<Version>>
                        {
                            SystemUnderTest = new Datapoint<Version>(
                                                      referenceObject.ReportingPeriod,
                                                      referenceObject.Value),
                            ExpectedPropertyValue = referenceObject.ReportingPeriod,
                        };

                        return result;
                    },
                    PropertyName = "ReportingPeriod",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Datapoint<Version>>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<Datapoint<Version>> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Datapoint<Version>>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Datapoint<Version>>
                {
                    Name = "DeepCloneWithReportingPeriod should deep clone object and replace ReportingPeriod with the provided reportingPeriod",
                    WithPropertyName = "ReportingPeriod",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Datapoint<Version>>();

                        var referenceObject = A.Dummy<Datapoint<Version>>().ThatIs(_ => !systemUnderTest.ReportingPeriod.IsEqualTo(_.ReportingPeriod));

                        var result = new SystemUnderTestDeepCloneWithValue<Datapoint<Version>>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ReportingPeriod,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Datapoint<Version>>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Datapoint<Version>>().ThatIs(_ => !systemUnderTest.Value.IsEqualTo(_.Value));
        ...
        private static readonly Datapoint<Version> ReferenceObjectForEquatableTestScenarios = A.Dummy<Datapoint<Version>>();

        private static readonly EquatableTestScenarios<Datapoint<Version>> EquatableTestScenarios = new EquatableTestScenarios<Datapoint<Version>>()
            .AddScenario(() =>
                new EquatableTestScenario<Datapoint<Version>>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new Datapoint<Version>[]
                    {
                        new Datapoint<Version>(
                                ReferenceObjectForEquatableTestScenarios.ReportingPeriod,
                                ReferenceObjectForEquatableTestScenarios.Value),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new Datapoint<Version>[]
                    {
                        new Datapoint<Version>(
                                A.Dummy<Datapoint<Version>>().Whose(_ => !_.ReportingPeriod.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ReportingPeriod)).ReportingPeriod,
                                ReferenceObjectForEquatableTestScenarios.Value),
                        new Datapoint<Version>(
                                ReferenceObjectForEquatableTestScenarios.ReportingPeriod,
                                A.Dummy<Datapoint<Version>>().Whose(_ => !_.Value.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Value)).Value),
                    },
        ...
        private static readonly ValidModelTestScenarios<Datapoint<Version>> ValidModelTestScenarios = new ValidModelTestScenarios<Datapoint<Version>>()
            .AddScenario(() =>
                new ValidModelTestScenario<Datapoint<Version>>
                {
                    Name = "a dummy Datapoint<Version> should be valid",
                    SystemUnderTest = A.Dummy<Datapoint<Version>>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void Datapoint_of_Version___Should_implement_IModel_of_Datapoint_of_Version___When_reflecting()
            {
                // Arrange
                var type = typeof(Datapoint<Version>);

                var expectedModelMethods = typeof(IModel<Datapoint<Version>>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Datapoint<Version>>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Datapoint_of_Version___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(Datapoint<Version>);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Datapoint<Version>)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ReportingPeriod == null)
                {
                    actual.ReportingPeriod.AsTest().Must().BeNull();
                }
                else if (!actual.ReportingPeriod.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.ReportingPeriod.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ReportingPeriod);
                }
            ...
            {
                var propertyNames = new string[] { "ReportingPeriod", "Value" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Datapoint<Version>)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(Datapoint<Version>).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<Datapoint<Version>>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Datapoint<Version> systemUnderTest1 = null;
                Datapoint<Version> systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    Datapoint<Version> systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Datapoint_of_Version___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Datapoint_of_Version___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Datapoint_of_Version___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Datapoint_of_Version___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Datapoint_of_Version___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
