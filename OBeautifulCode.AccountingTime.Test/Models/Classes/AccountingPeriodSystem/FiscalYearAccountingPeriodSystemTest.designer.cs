...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<FiscalYearAccountingPeriodSystem> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<FiscalYearAccountingPeriodSystem>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<FiscalYearAccountingPeriodSystem>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<FiscalYearAccountingPeriodSystem>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.AccountingTime.FiscalYearAccountingPeriodSystem: LastMonthInFiscalYear = {systemUnderTest.LastMonthInFiscalYear.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<FiscalYearAccountingPeriodSystem> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<FiscalYearAccountingPeriodSystem>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<FiscalYearAccountingPeriodSystem> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<FiscalYearAccountingPeriodSystem>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<FiscalYearAccountingPeriodSystem>
                {
                    Name = "LastMonthInFiscalYear should return same 'lastMonthInFiscalYear' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<FiscalYearAccountingPeriodSystem>();

                        var result = new SystemUnderTestExpectedPropertyValue<FiscalYearAccountingPeriodSystem>
                        {
                            SystemUnderTest = new FiscalYearAccountingPeriodSystem(
                                                      referenceObject.LastMonthInFiscalYear),
                            ExpectedPropertyValue = referenceObject.LastMonthInFiscalYear,
                        };

                        return result;
                    },
                    PropertyName = "LastMonthInFiscalYear",
                });

        private static readonly DeepCloneWithTestScenarios<FiscalYearAccountingPeriodSystem> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<FiscalYearAccountingPeriodSystem>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<FiscalYearAccountingPeriodSystem>
                {
                    Name = "DeepCloneWithLastMonthInFiscalYear should deep clone object and replace LastMonthInFiscalYear with the provided lastMonthInFiscalYear",
                    WithPropertyName = "LastMonthInFiscalYear",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<FiscalYearAccountingPeriodSystem>();

                        var referenceObject = A.Dummy<FiscalYearAccountingPeriodSystem>().ThatIs(_ => !systemUnderTest.LastMonthInFiscalYear.IsEqualTo(_.LastMonthInFiscalYear));

                        var result = new SystemUnderTestDeepCloneWithValue<FiscalYearAccountingPeriodSystem>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.LastMonthInFiscalYear,
                        };
        ...
        private static readonly FiscalYearAccountingPeriodSystem ReferenceObjectForEquatableTestScenarios = A.Dummy<FiscalYearAccountingPeriodSystem>();

        private static readonly EquatableTestScenarios<FiscalYearAccountingPeriodSystem> EquatableTestScenarios = new EquatableTestScenarios<FiscalYearAccountingPeriodSystem>()
            .AddScenario(() =>
                new EquatableTestScenario<FiscalYearAccountingPeriodSystem>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new FiscalYearAccountingPeriodSystem[]
                    {
                        new FiscalYearAccountingPeriodSystem(
                                ReferenceObjectForEquatableTestScenarios.LastMonthInFiscalYear),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new FiscalYearAccountingPeriodSystem[]
                    {
                        new FiscalYearAccountingPeriodSystem(
                                A.Dummy<FiscalYearAccountingPeriodSystem>().Whose(_ => !_.LastMonthInFiscalYear.IsEqualTo(ReferenceObjectForEquatableTestScenarios.LastMonthInFiscalYear)).LastMonthInFiscalYear),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<FiftyTwoFiftyThreeWeekAccountingPeriodSystem>(),
                    },
                });

        private static readonly ValidModelTestScenarios<FiscalYearAccountingPeriodSystem> ValidModelTestScenarios = new ValidModelTestScenarios<FiscalYearAccountingPeriodSystem>()
            .AddScenario(() =>
                new ValidModelTestScenario<FiscalYearAccountingPeriodSystem>
                {
                    Name = "a dummy FiscalYearAccountingPeriodSystem should be valid",
                    SystemUnderTest = A.Dummy<FiscalYearAccountingPeriodSystem>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void FiscalYearAccountingPeriodSystem___Should_implement_IModel_of_FiscalYearAccountingPeriodSystem___When_reflecting()
            {
                // Arrange
                var type = typeof(FiscalYearAccountingPeriodSystem);

                var expectedModelMethods = typeof(IModel<FiscalYearAccountingPeriodSystem>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<FiscalYearAccountingPeriodSystem>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void FiscalYearAccountingPeriodSystem___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(FiscalYearAccountingPeriodSystem);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (FiscalYearAccountingPeriodSystem)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "LastMonthInFiscalYear" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (FiscalYearAccountingPeriodSystem)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(FiscalYearAccountingPeriodSystem).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<FiscalYearAccountingPeriodSystem>();
        ...
        public static class Equality
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FiscalYearAccountingPeriodSystem___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
