...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        public static void Deserialize___Should_return_equivalent_object_of_type_GenericUnbounded___When_an_object_of_that_type_is_serialized_to_json_and_deserialized_as_abstract_type()
        {
            ...
            // Act
            var systemUnderTest1 = JsonConvert.DeserializeObject<UnitOfTime>(serializedJson, settings) as GenericUnbounded;
            var systemUnderTest2 = JsonConvert.DeserializeObject<GenericUnitOfTime>(serializedJson, settings) as GenericUnbounded;
