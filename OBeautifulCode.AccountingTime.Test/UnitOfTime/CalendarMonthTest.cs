...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        [Fact]
        public static void GetHashCode___Should_not_be_equal_for_two_CalendarMonths___When_CalendarMonths_have_different_property_values()
        {
            // Arrange
            var systemUnderTest1a = A.Dummy<CalendarMonth>();
            var systemUnderTest1b = A.Dummy<CalendarMonth>();
        ...
        [Fact]
        public static void GetHashCode___Should_be_equal_for_two_CalendarMonths___When_both_CalendarMonths_have_the_same_property_values()
        {
            // Arrange
            var systemUnderTest1 = A.Dummy<CalendarMonth>();
            var systemUnderTest2 = new CalendarMonth(systemUnderTest1.Year, systemUnderTest1.MonthOfYear);
