...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    public static class FiscalQuarterTest
    {
        ...
        {
            // Arrange, Act
            var ex1 = Record.Exception(() => new FiscalQuarter(0, A.Dummy<QuarterNumber>()));
            var ex2 = Record.Exception(() => new FiscalQuarter(A.Dummy<ZeroOrNegativeInteger>(), A.Dummy<QuarterNumber>()));
        ...
        {
            // Arrange, Act
            var ex1 = Record.Exception(() => new FiscalQuarter(10000, A.Dummy<QuarterNumber>()));
            var ex2 = Record.Exception(() => new FiscalQuarter(A.Dummy<PositiveInteger>().ThatIs(y => y > 9999), A.Dummy<QuarterNumber>()));
        ...
        public static void Year___Should_return_same_year_passed_to_constructor___When_getting()
        {
            ...
            var systemUnderTest = new FiscalQuarter(year, quarter);
        ...
        public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
        {
            // Arrange
            FiscalQuarter systemUnderTest1 = null;
            var systemUnderTest2 = A.Dummy<FiscalQuarter>();
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        public static void EqualsOperator___Should_return_false___When_objects_being_compared_have_different_property_values()
        {
            ...
            var systemUnderTest2b = systemUnderTest2a.TweakComponentOfFiscalQuarter(FiscalQuarterComponent.Quarter);

            var systemUnderTest3a = A.Dummy<FiscalQuarter>();
            var systemUnderTest3b = systemUnderTest3a.TweakComponentOfFiscalQuarter(FiscalQuarterComponent.Year);
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        [Fact]
        public static void GetHashCode___Should_not_be_equal_for_two_FiscalQuarters___When_both_objects_have_different_property_values()
        {
            // Arrange
            var systemUnderTest2a = A.Dummy<FiscalQuarter>();
            var systemUnderTest2b = systemUnderTest2a.TweakComponentOfFiscalQuarter(FiscalQuarterComponent.Quarter);
        ...
        [Fact]
        public static void GetHashCode___Should_be_equal_for_two_FiscalQuarters___When_both_objects_have_the_same_property_values()
        {
            // Arrange
            var systemUnderTest1 = A.Dummy<FiscalQuarter>();
            var systemUnderTest2 = new FiscalQuarter(systemUnderTest1.Year, systemUnderTest1.QuarterNumber);
        ...
        public static void Deserialize___Should_return_equivalent_object_of_type_FiscalQuarter___When_an_object_of_that_type_is_serialized_to_json_and_deserialized_as_abstract_type()
        {
            ...
            // Act
            var systemUnderTest1 = JsonConvert.DeserializeObject<UnitOfTime>(serializedJson, settings) as FiscalQuarter;
            var systemUnderTest2 = JsonConvert.DeserializeObject<FiscalUnitOfTime>(serializedJson, settings) as FiscalQuarter;
