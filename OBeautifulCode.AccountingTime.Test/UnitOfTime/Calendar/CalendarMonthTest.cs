            ...
            ConstructorArgumentValidationTestScenarios
                ...
                .AddScenario(() =>
                    new ConstructorArgumentValidationTestScenario<CalendarMonth>
                    {
                        ...
                        ConstructionFunc = () => new CalendarMonth(A.Dummy<PositiveInteger>().ThatIs(_ => _ > 9999), referenceCalendarMonth.MonthOfYear),
                        ExpectedExceptionMessageContains = new[] { "year", "not less than or equal to" },
                        ExpectedExceptionType = typeof(ArgumentOutOfRangeException),
                    })
                .AddScenario(() =>
                ...
                .AddScenario(() =>
                    new ComparableTestScenario<CalendarMonth>
                    {
                        ...
                        ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new[]
                            ...
                            .Concat(Common.GetDummyOfEachUnitOfTimeKind().Where(_ => _.GetType() != typeof(CalendarMonth)))
                            .ToList(),
