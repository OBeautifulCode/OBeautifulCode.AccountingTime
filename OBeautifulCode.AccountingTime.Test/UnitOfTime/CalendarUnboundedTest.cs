...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    public static class CalendarUnboundedTest
    {
        [Fact]
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        [Fact]
        public static void GetHashCode___Should_be_equal_for_two_CalendarUnbounded___When_called()
        {
            // Arrange
            var systemUnderTest1 = A.Dummy<CalendarUnbounded>();
            var systemUnderTest2 = A.Dummy<CalendarUnbounded>();
        ...
        {
            // Arrange
            var systemUnderTest1a = A.Dummy<CalendarUnbounded>();
            var systemUnderTest1b = A.Dummy<CalendarUnbounded>();
        ...
        public static void Deserialize___Should_return_equivalent_object_of_type_CalendarUnbounded___When_an_object_of_that_type_is_serialized_to_json_and_deserialized_as_abstract_type()
        {
            ...
            // Act
            var systemUnderTest1 = JsonConvert.DeserializeObject<UnitOfTime>(serializedJson, settings) as CalendarUnbounded;
            var systemUnderTest2 = JsonConvert.DeserializeObject<CalendarUnitOfTime>(serializedJson, settings) as CalendarUnbounded;
