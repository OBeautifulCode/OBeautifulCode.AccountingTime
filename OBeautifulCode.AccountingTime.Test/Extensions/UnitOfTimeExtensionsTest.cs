...
namespace OBeautifulCode.AccountingTime.Test
{
    ...
    public static class UnitOfTimeExtensionsTest
    {
        ...
        [Fact]
        public static void ToKind_with_GenericUnitOfTime___Should_throw_ArgumentNullException___When_parameter_genericUnitOfTime_is_null()
        {
            // Arrange, Act
            var ex = Record.Exception(() => UnitOfTimeExtensions.ToKind(null, A.Dummy<UnitOfTimeKind>()));
        ...
        [Fact]
        public static void ToKind_with_GenericUnitOfTime___Should_throw_ArgumentException___When_parameter_unitOfTimeKind_is_Invalid()
        {
            // Arrange, Act
            var ex = Record.Exception(() => A.Dummy<GenericUnitOfTime>().ToKind(UnitOfTimeKind.Invalid));
        ...
        [Fact]
        public static void ToKind_with_GenericUnitOfTime___Should_return_the_genericUnitOfTime_converted_into_a_CalendarUnitOfTime____When_unitOfTimeKind_is_Calendar()
        {
            // Arrange
            var toConvert = new List<Tuple<GenericUnitOfTime, CalendarUnitOfTime>>
            {
                { new GenericMonth(2018, MonthNumber.Eleven), new CalendarMonth(2018, MonthOfYear.November) },
                { new GenericQuarter(2015, QuarterNumber.Q3), new CalendarQuarter(2015, QuarterNumber.Q3) },
                { new GenericYear(2016), new CalendarYear(2016) },
                { new GenericUnbounded(), new CalendarUnbounded() }
            };

            // Act
            var results = toConvert.Select(_ => new { Actual = _.Item1.ToKind(UnitOfTimeKind.Calendar), Expected = _.Item2 }).ToList();
        ...
        [Fact]
        public static void ToKind_with_GenericUnitOfTime___Should_return_the_genericUnitOfTime_converted_into_a_FiscalUnitOfTime____When_unitOfTimeKind_is_Fiscal()
        {
            // Arrange
            var toConvert = new List<Tuple<GenericUnitOfTime, FiscalUnitOfTime>>
            {
                { new GenericMonth(2018, MonthNumber.Five), new FiscalMonth(2018, MonthNumber.Five) },
                { new GenericQuarter(2015, QuarterNumber.Q4), new FiscalQuarter(2015, QuarterNumber.Q4) },
                { new GenericYear(2016), new FiscalYear(2016) },
                { new GenericUnbounded(), new FiscalUnbounded() }
            };

            // Act
            var results = toConvert.Select(_ => new { Actual = _.Item1.ToKind(UnitOfTimeKind.Fiscal), Expected = _.Item2 }).ToList();
        ...
        [Fact]
        public static void ToKind_with_GenericUnitOfTime___Should_return_the_genericUnitOfTime_converted_into_a_GenericUnitOfTime____When_unitOfTimeKind_is_Generic()
        {
            // Arrange
            var toConvert = new List<Tuple<GenericUnitOfTime, GenericUnitOfTime>>
            {
                { new GenericMonth(2018, MonthNumber.Five), new GenericMonth(2018, MonthNumber.Five) },
                { new GenericQuarter(2015, QuarterNumber.Q4), new GenericQuarter(2015, QuarterNumber.Q4) },
                { new GenericYear(2016), new GenericYear(2016) },
                { new GenericUnbounded(), new GenericUnbounded() }
            };

            // Act
            var results = toConvert.Select(_ => new { Actual = _.Item1.ToKind(UnitOfTimeKind.Generic), Expected = _.Item2 }).ToList();
        ...
        [Fact]
        public static void ToKind_with_GenericUnitOfTime___Should_return_different_object_than_specified_genericUnitOfTime____When_unitOfTimeKind_is_Generic()
        {
            // Arrange
            var genericUnitOfTime = A.Dummy<GenericUnitOfTime>();

            // Act
            var converted = genericUnitOfTime.ToKind(UnitOfTimeKind.Generic);

            // Assert
            converted.Should().NotBeSameAs(genericUnitOfTime);
        }

        [Fact]
        public static void ToCalendar_with_GenericUnitOfTime___Should_throw_ArgumentNullException___When_parameter_genericUnitOfTime_is_null()
        {
            // Arrange, Act
            var ex = Record.Exception(() => UnitOfTimeExtensions.ToCalendar(null));
        ...
        [Fact]
        public static void ToCalendar_with_GenericUnitOfTime___Should_return_the_genericUnitOfTime_converted_into_a_CalendarUnitOfTime____When_called()
        {
            // Arrange
            var toConvert = new List<Tuple<GenericUnitOfTime, CalendarUnitOfTime>>
            {
        ...
        [Fact]
        public static void ToFiscal_with_GenericUnitOfTime___Should_throw_ArgumentNullException___When_parameter_genericUnitOfTime_is_null()
        {
            // Arrange, Act
            var ex = Record.Exception(() => UnitOfTimeExtensions.ToFiscal(null));
        ...
        [Fact]
        public static void ToFiscal_with_GenericUnitOfTime___Should_return_the_genericUnitOfTime_converted_into_a_FiscalUnitOfTime____When_called()
        {
            // Arrange
            var toConvert = new List<Tuple<GenericUnitOfTime, FiscalUnitOfTime>>
            {
            ...
            // Act
            var results = toConvert.Select(_ => new { Actual = _.Item1.ToFiscal(), Expected = _.Item2 }).ToList();
        ...
        [Fact]
        public static void ToGeneric_with_GenericUnitOfTime___Should_throw_ArgumentNullException___When_parameter_genericUnitOfTime_is_null()
        {
            // Arrange, Act
            var ex = Record.Exception(() => UnitOfTimeExtensions.ToGeneric(null));
        ...
        [Fact]
        public static void ToGeneric_with_GenericUnitOfTime___Should_return_the_genericUnitOfTime_converted_into_a_GenericUnitOfTime____When_called()
        {
            // Arrange
            var toConvert = new List<Tuple<GenericUnitOfTime, GenericUnitOfTime>>
            {
            ...
            // Act
            var results = toConvert.Select(_ => new { Actual = _.Item1.ToGeneric(), Expected = _.Item2 }).ToList();
        ...
        [Fact]
        public static void ToGeneric_with_GenericUnitOfTime___Should_return_different_object_than_specified_genericUnitOfTime____When_called()
        {
            // Arrange
            var genericUnitOfTime = A.Dummy<GenericUnitOfTime>();

            // Act
            var converted = genericUnitOfTime.ToGeneric();
